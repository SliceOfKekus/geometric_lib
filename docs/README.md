...
Количество успешно пройденных тестов - 15
## ```TestTriangle```
Класс ```TestTriangle``` тестирует основную функциональность, предоставленную модулем ```rectangle.py```. Тесты покрывают различные ситуации, включая отрицательные и нулевые значения.

## ```TestSquare```
Класс ```TestSquare``` тестирует основную функциональность, предоставленную модулем ```square.py```. Тесты покрывают различные ситуации, включая отрицательные и нулевые значения.

## ```TestRectangle```
Класс ```TestRectangle``` тестирует основную функциональность, предоставленную модулем ```rectangle.py```. Тесты покрывают различные ситуации, включая отрицательные и нулевые значения.

## ```TestCircle```
Класс ```TestCircle``` тестирует основную функциональность, предоставленную модулем ```circle.py```. Тесты покрывают различные ситуации, включая отрицательные и нулевые значения.
